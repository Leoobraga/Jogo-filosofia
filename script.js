...
(() => {
  ...
  const QUESTIONS = [
    ...
    { q: "Se vocẽ descobrisse um segredo cientifico que poderia mudar o futuor, mas teria que guardar pra vocẽ... contaria ou ficaria calado", options: ["Contaria, pois a verdade deve ser compartilhada.", "ficaria calado, para não ser punido e nem colocar ninguem em risco", "Revelaria apenas para alguem de confiança.", "Guardaria em codigo secreto , para que apenas "], correctObf: btoa(String(0 + OBFUSCATION_OFFSET)), hint: "Filósofo que abordou o 'eterno retorno' e a 'vontade de poder'." },
