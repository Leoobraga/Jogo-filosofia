...
(() => {
  ...
  const QUESTIONS = [
    ...
    { q: "Quem escreveu 'Assim falou Zaratustra'?", options: ["Nietzsche", "Kierkegaard", "Mill", "Hume"], correctObf: btoa(String(0 + OBFUSCATION_OFFSET)), hint: "Filósofo que abordou o 'eterno retorno' e a 'vontade de poder'." },
